...
const primaryRes = createResource({ url: 'press_billing.dashboard.set_default_payment_method', onSuccess: () => methods.reload() });
const reorderRes = createResource({ url: 'press_billing.dashboard.reorder_payment_methods', onSuccess: () => methods.reload() });
