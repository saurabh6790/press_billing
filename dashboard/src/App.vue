...
createResource({ url: 'billing.api.dashboard.whoami', auto: true, onSuccess: (d) => { store.team = d.team; store.isAdmin = d.is_billing_admin; } });
const teams = createResource({ url: 'billing.api.dashboard.list_switchable_teams', auto: true });
