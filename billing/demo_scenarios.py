...
"""Comprehensive demo dataset for the billing portal (#demo).
    ...
    bench --site billing.local execute billing.demo_scenarios.seed_all
...
def seed_all() -> dict:
	from billing.dashboard import ensure_billing_team_field
	...
	from billing.demo import _ensure_workspace
